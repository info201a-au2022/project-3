...
interactive_page3 <- tabPanel(
  ...
  mainPanel(
    leafletOutput(outputId = "PercentReceived"),
  mainPanel(
    br(),
    br(),
...
"),
  ...
  p("P., Devakumar K. “HIV AIDS Dataset.” Kaggle, 11 June 2020, www.kaggle.com/datasets/imdevskp/hiv-aids-dataset?select=no_of_deaths_by_country_clean.csv. ")
