...
```
=======
Instead of a focus on countries, I decided to show how the frequencies of the amount of median deaths per countries exists. It is interesting beacause it showed lower frequencies of more death rates.
